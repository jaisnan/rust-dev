...
VERIFY_RUST_STD_DIR="path/to/your/local/repository"
KANI_DIR="path/to/kani/repository"
...
echo
cd "$KANI_DIR"
./scripts/setup/ubuntu/install_deps.sh  # Replace with the appropriate script for your OS
